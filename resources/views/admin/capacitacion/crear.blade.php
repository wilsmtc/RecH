    ...
    <div class="col-lg-12">
        ...
        <div class="box box-primary">
            <div style="text-align: center;" class="box-header whit.border">
                <h3 class="box-title"><b>Crear Capacitación</b></h3>
                <div class="box-tools pull-right">
                    <a href="{{route('capacitacion')}}" class="btn btn-block btn-info btn-sm">
                        <i class="fa fa-fw fa-reply-all"></i> Ver Capacitaciones
                    </a>
                </div>
            </div>
            <form action="{{route ('guardar_capacitacion')}}" id="form-general" class="form-horizontal" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="box-body">
