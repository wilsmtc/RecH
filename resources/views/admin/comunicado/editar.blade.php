...
<div class="row">
    <div class="col-lg-12">
        ...
        <div class="box box-primary">
            ...
            <h3 class="box-title"><b>Editar {{$comunicado->tipo}}</b></h3>
            ...
            <form action="{{route('actualizar_comunicado', ['id' => $comunicado->id])}}" id="form-general" class="form-horizontal" method="POST" enctype="multipart/form-data">
                @csrf @method("put")
                <div class="box-body">
