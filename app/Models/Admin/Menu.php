...
{
     protected $table = "menu"; // la tabla a la q hace referencia
     ...
     {
          $menus = new Menu();   //instanciando la clase menu
          $padres = $menus->getPadres($front);  //contendra todos los menu_id=0 osea los padres
          $menuAll = [];
     ...
     //funcion para guardar el orden de los menus en la BD
